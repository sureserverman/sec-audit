...
field mappings to sec-review's finding schema, and offline-degrade rules.
...
### cargo-audit → sec-review finding

| cargo-audit JSON field                        | sec-review finding field | Notes                                                                                                                                                                                     |
|-----------------------------------------------|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
### cargo-deny → sec-review finding

cargo-deny emits one diagnostic object per issue. Each diagnostic maps to
exactly one sec-review finding.

| cargo-deny JSON field | sec-review finding field | Notes                                                                                                                                                                              |
|-----------------------|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
### cargo-geiger → sec-review finding
...
| cargo-geiger JSON field                             | sec-review finding field | Notes                                                                                                         |
|-----------------------------------------------------|--------------------------|---------------------------------------------------------------------------------------------------------------|
...
### cargo-vet → sec-review finding

Every entry in `suggestions[]` produces exactly ONE finding.

| cargo-vet JSON field    | sec-review finding field | Notes                                                                                                       |
|-------------------------|--------------------------|-------------------------------------------------------------------------------------------------------------|
