...
<!--
    Tool-lane reference for sec-review's Linux desktop lane (v0.10.0+).
...
### systemd-analyze → sec-review finding

| upstream (per-directive row)            | sec-review field                 |
|-----------------------------------------|----------------------------------|
...
### lintian → sec-review finding

| Lintian JSON field                      | sec-review field                 |
|-----------------------------------------|----------------------------------|
| `"lintian:" + tag`                      | `id`                             |
...
### checksec → sec-review finding

| checksec JSON field                     | sec-review field                 |
|-----------------------------------------|----------------------------------|
