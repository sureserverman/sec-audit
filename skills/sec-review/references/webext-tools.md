...
sec-review's finding schema, and offline-degrade rules. Out of scope:
...
### addons-linter → sec-review finding

| addons-linter JSON field | sec-review finding field | Notes                                                                                    |
|--------------------------|--------------------------|------------------------------------------------------------------------------------------|
...
### web-ext lint → sec-review finding
...
### retire.js → sec-review finding

retire.js emits one array element per vulnerable component/file pair. When a
component has multiple vulnerabilities, emit one sec-review finding per
vulnerability entry.

| retire.js JSON field                         | sec-review finding field | Notes                                                                                            |
|----------------------------------------------|--------------------------|--------------------------------------------------------------------------------------------------|
...
### Recipe: addons-linter / web-ext finding → sec-review finding
...
parent array's `type` value. Emit one sec-review finding per item.
...
### Recipe: retire.js finding → sec-review finding

retire.js produces an array of component objects, each with a
`vulnerabilities[]` sub-array. Emit one sec-review finding per
vulnerability.
