...
<!--
    Tool-lane reference for sec-review's Desktop Windows lane
...
### binskim → sec-review finding

| SARIF field                                | sec-review field                 |
|--------------------------------------------|----------------------------------|
| `"binskim:" + ruleId`                       | `id`                             |
...
### osslsigncode → sec-review finding
