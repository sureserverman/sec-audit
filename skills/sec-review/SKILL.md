...
- `only_lanes` (optional, v1.0.0+) — list of canonical lane names
  ...
  `gh-actions` (added v1.3), `virt` (added v1.4), `go` (added v1.5), `shell` (added v1.6). When set, the orchestrator dispatches
...
The canonical lane list (16 total) is enumerated in
