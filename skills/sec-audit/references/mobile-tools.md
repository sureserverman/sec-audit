...
canonical CLI invocations, JSON/XML output schemas, field mappings to sec-audit's
...
values matched). One sec-audit finding is emitted per match string.
...
### apkleaks → sec-audit finding

One finding is emitted per match string within each results entry. A rule
with three matches produces three sec-audit findings.

| apkleaks JSON field                                   | sec-audit finding field | Notes                                                                                                                                                        |
|-------------------------------------------------------|--------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
### android-lint → sec-audit finding

Parse the XML report using `xml.etree.ElementTree`. One sec-audit finding
is emitted per `<issue>` / `<location>` pair. An issue with two location
elements (e.g. in a merged manifest) produces two findings.

| android-lint XML attribute              | sec-audit finding field | Notes                                                                                                                                        |
|-----------------------------------------|--------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
...
### codesign → sec-audit finding (iOS lane)
...
| upstream field                          | sec-audit field              |
|-----------------------------------------|-------------------------------|
...
### spctl → sec-audit finding (iOS lane)
...
### xcrun notarytool → sec-audit finding (iOS lane)
...
### pkgutil → sec-audit finding (macOS lane, v0.11.0+)
...
### stapler validate → sec-audit finding (macOS lane, v0.11.0+)
...
rather than as reviewer-fixable gaps. The sec-audit report surfaces
