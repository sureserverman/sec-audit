...
- Shell scripts under `tests/fixtures/` that are intentionally vulnerable as fixtures for sec-audit's own validation — annotate; downgrade to INFO unless mistakenly shipped to production.
